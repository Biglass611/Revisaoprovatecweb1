...
public class Funcionario {
    ...
    @Column(name = "funcionario_chaveAcesso")
    private String chaveAcesso;
    @Column(name = "funcionario_status")
    private Integer status;

    @OneToMany(mappedBy = "funcionario")
    private Set<FolhaPagamento> folhaPagamentos;
    ...
    public Set<FolhaPagamento> getFolhaPagamentos() {
        return folhaPagamentos;
    }

    public void setFolhaPagamentos(Set<FolhaPagamento> folhaPagamentos) {
